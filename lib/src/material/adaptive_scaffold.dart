...
class _AdaptiveScaffoldState extends State<AdaptiveScaffold> {
  ...
  SlotLayout _createBottomNavigation() {
    return SlotLayout(
      config: <Breakpoint, SlotLayoutConfig>{
        widget.breakpoints.small: SlotLayout.from(
  ...
  SlotLayout _createPrimaryNavigation(
    List<NavigationRailDestination> destinations,
    NavigationRailThemeData navRailTheme,
  ) {
    return SlotLayout(
      config: <Breakpoint, SlotLayoutConfig>{
        widget.breakpoints.medium: SlotLayout.from(
        ...
        widget.breakpoints.mediumLarge: SlotLayout.from(
        ...
        widget.breakpoints.large: SlotLayout.from(
        ...
        widget.breakpoints.extraLarge: SlotLayout.from(
